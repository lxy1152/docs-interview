...
<Tabs
    defaultValue="修饰变量"
    values={[
        {label: '修饰变量', value: '修饰变量'},
        {label: '修饰方法', value: '修饰方法'},
        {label: '修饰类', value: '修饰类'}
]}>
...
<Tabs
    ...
    values={[
        {label: '修饰变量', value: '修饰变量'},
        {label: '修饰方法', value: '修饰方法'},
        {label: '修饰一段代码块', value: '修饰一段代码块'},
        {label: '修饰内部类', value: '修饰内部类'},
        {label: '静态导包', value: '静态导包'}
]}>
...
:::info 类的初始化顺序
<CenterImage alt="init_order">https://i.loli.net/2021/07/29/YTFHv7G2xny9la8.png</CenterImage>
:::
