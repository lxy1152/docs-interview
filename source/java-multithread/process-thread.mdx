...
<Tabs
    defaultValue="实现 Runnable 接口"
    values={[
        {label: '实现 Runnable 接口', value: '实现 Runnable 接口'},
        {label: '实现 Callable 接口', value: '实现 Callable 接口'},
        {label: '继承 Thread 类', value: '继承 Thread 类'}
]}>

<TabItem value="实现 Runnable 接口">
...
<Tabs
    ...
    values={[
        ...
        {label: 'wait()，notify() 以及 notifyAll()', value: 'wait()'},
        {label: 'await()，signal() 以及 signalAll()', value: 'await()'}
]}>
