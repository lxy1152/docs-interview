...
<Tabs
    defaultValue="主动引用"
    values={[
        {label: '主动引用', value: '主动引用'},
        {label: '被动引用', value: '被动引用'}
]}>
...
<Tabs
    ...
    values={[
        {label: '校验', value: '校验'},
        {label: '分配内存', value: '分配内存'},
        {label: '初始化', value: '初始化'},
        {label: '设置', value: '设置'},
        {label: '初始化赋值', value: '初始化赋值'}
]}>
...
<Tabs
    defaultValue="实现自定义的类加载器"
    values={[
        {label: '实现自定义的类加载器', value: '实现自定义的类加载器'},
        {label: 'ServiceLoader', value: 'ServiceLoader'}
]}>

<TabItem value="实现自定义的类加载器">
