...
<Tabs
    defaultValue="懒汉式（线程不安全）"
    values={[
        {label: '懒汉式（线程不安全）', value: '懒汉式（线程不安全）'},
        {label: '懒汉式（线程安全）', value: '懒汉式（线程安全）'},
        {label: '饿汉式', value: '饿汉式'},
        {label: '双检锁', value: '双检锁'},
        {label: '静态内部类', value: '静态内部类'}
]}>

<TabItem value="懒汉式（线程不安全）">
